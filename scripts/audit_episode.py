#!/usr/bin/env python3
"""Audit one canonical episode and write quality_report.json."""
...
from conveyor_bench.schema.quality import (  # noqa: E402
    DataStatus,
    FrameStatsProvider,
    audit_episode,
)
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        print(f"audit_episode: {error}", file=sys.stderr)
        return 2
    print(
        json.dumps(
            {
