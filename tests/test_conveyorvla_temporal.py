    ...
    assert config["data"]["navigation_action_composer"]["phases"] == {
        "NAV_TO_SOURCE": {
            ...
            "arm_joint_reference": pytest.approx(
                [-1.9385699488339014e-05, 5.3811760153621435e-05, -7.183002708188724e-06, -0.0010875172447413206, 1.235702438862063e-05, -2.1801217826578068e-06]
            ),
        ...
        "NAV_TO_TARGET": {
            "mode": "carry_closed",
            "arm_joint_reference": pytest.approx(
                [1.6024008800741285e-05, 0.00043930605170316994, -4.119918230571784e-06, -0.0022762841545045376, -8.16499232314527e-06, 2.8425533855624963e-06]
            ),
