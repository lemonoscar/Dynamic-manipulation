"""Validated conveyor workcell, robot and three-camera scene.
...
from conveyor_bench.schema.assets import ObjectAsset, load_object_registry, load_receptacles

from .asset_config import TCP_OFFSET_X_M, make_go2_x5_cfg
from .physics import (
    collision_properties as _collision,
    spawn_direct_cuboid as _spawn_direct_cuboid,
)
...
# Observer-only view, deliberately far enough to show the full workcell.
...
def _spawn_sort_tray(
    ...
    *,
    ...
    # the floor from the manifest-driven center preserves the calibrated value
...
def spawn_conveyor_workcell(
    ...
    **_: object,
    ...
    # may omit them to leave a clear mobile-delivery corridor; previews keep them by
    # default.
    ...
    # The procedural preview keeps this room; the NuRec scene disables it so
...
@configclass
class ConveyorWorkcellCfg(InteractiveSceneCfg):
    """Complete procedural workcell with an eight-object reusable pool."""
