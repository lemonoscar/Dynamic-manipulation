#!/usr/bin/env python3
"""Export canonical episodes into local VLA JSONL views."""
...
from conveyor_bench.schema.exporters import (  # noqa: E402
...
def find_episodes(source: str | Path) -> tuple[Path, ...]:
    ...
    if not episodes:
        raise ValueError(f"no published episodes found under {path}")
    return episodes
