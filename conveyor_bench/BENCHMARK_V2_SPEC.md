...
场景都复用 V1 的横向低位真实工位语义：传送带顶面高 `0.50 m`，物体沿
`[0, -1, 0]` 从 `+Y → -Y` 运动，因此从机器人视角看是左到右。
...
| --- | --- | --- |
| `sort_bin_blue` | `(0.34, 0.43, 0.40)` | `(0.105, 0.125, 0.075)` |
| `sort_bin_yellow` | `(0.34, -0.43, 0.40)` | `(0.105, 0.125, 0.075)` |
