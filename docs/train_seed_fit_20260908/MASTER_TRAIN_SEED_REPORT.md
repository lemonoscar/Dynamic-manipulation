最新更新：用户指定仅60秒仿真时钟结束的模式已真实跑满60.0秒/3000ticks/150queries，GPU已释放。模型21.2s进入PICK、31.8s进入NAV_TO_TARGET，但物体未抓起且未进入PLACE；详见timer60/TIMER60_REPORT.md。以下保留此前有界尝试的历史证据。
